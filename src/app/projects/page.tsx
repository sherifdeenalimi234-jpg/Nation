...
import { PROJECTS_DATA, TEAMS_DATA, getPublishedOnly } from "@/lib/contentStore";
import { FolderGit2, ArrowUpRight, Tag, MapPin } from "lucide-react";

export default function ProjectsPage() {
  const publishedProjects = getPublishedOnly(PROJECTS_DATA);
